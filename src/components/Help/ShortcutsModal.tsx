  ...
  const shortcutPages: ShortcutGroup[][] = [
    ...
    [
      ...
      },
      {
        title: '编辑（两种模式通用）',
        shortcuts: [
          { label: '行首打开插入菜单（富文本）', keys: ['/'] },
          { label: '整块上移 / 下移（富文本）', keys: [altKey, '↑', '·', altKey, '↓'] },
          { label: '选中下一处相同的文字（源码）', keys: [modKey, 'D'] },
        ],
      },
    ],
    [
      ...
      },
      {
        ...
        shortcuts: [
          ...
          { label: '推入废纸篓', keys: ['⌫'] },
          { label: '新建文档 / 文件夹', keys: ['文件夹名右侧按钮或右键'] },
        ],
      },
    ],
  ];
